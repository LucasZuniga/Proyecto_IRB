"""
Modulo extraido de https://github.com/getis/micropython-web-control-panel/blob/main/ResponseBuilder.py
Su funcion es la correcta redaccion y lectura de la comunicacion via protocolo http
"""
